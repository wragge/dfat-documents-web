...
doc_order: 155
naa_refs: []
title: Extract from Brief for Anthony's Meeting with Muldoon
...
## Australian Attitude
  ...
  24. In outlining Australia's position as part of the proposed general review at the outset of the meeting it could be emphasised that we wish to obtain a clear statement of New Zealand's position of the following: 
    ...
    * the elimination of performance-based export incentives in trans-Tasman trade by 1987 (particularly in an environment where Australia is scaling down its own scheme)
    * ...[5](#f5) it could also be indicated that, whilst agreeable to industry-to-industry consultations taking place on dairy products, Australia would first wish to hear New Zealand's view on arrangements for progressing negotiations across the range of agricultural issues, including monopoly import arrangements and horticulture
  25. In regard to government purchasing, it would be appropriate to recall New Zealand's wish to have a mission of officials visit the States and to indicate that the Prime Minister will be writing to Premiers inviting them to consider the New Zealand position.[6](#f6)
