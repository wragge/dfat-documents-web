...
naa_refs:
- naa_barcode: 1343605
  naa_control_symbol: C3348
  naa_series: A4940
  reference: '[NAA: A4940, C3348]'
title: Submission from Menzies to Cabinet
...
## 51 Submission from Menzies[1](#f1) to Cabinet
...
## Conclusions:
  ...
  31. I recommend that I be authorized 
    ...
    2. to send at the same time a Prime Ministerial message to the United Kingdom seeking recognition now of the United Kingdom's obligation to provide Australia, if ever necessary, with a nuclear capability (para. 26).[4](#f4)
