...
title: Briefing Note from Morris to McIntyre
...
## 76 Briefing Note from Morris[1](#f1) to McIntyre[2](#f2)
...
## Proposal for an Australian Nuclear Power Reactor
  ...
  4. In departmental advice submitted to the Minister[4](#f4) for his possible use in Cabinet, the following points were made on this proposal: 
...
## Conclusions
  ...
  13. The Defence Committee is unlikely to take any substantive decisions on the complex material put forward in the Agendum papers, or on Sir Leslie Martin's report.[6](#f6) However, if the question of further action to be taken is raised it is suggested you adopt the following position: 
