...
naa_refs:
- naa_barcode: 206103
  naa_control_symbol: C41/1/1
  naa_series: A1608
  reference: '[AA:A1608, C41/1/1]'
...
(3) That the only true basis for a new order in Europe is willing co-operation of free peoples in a system of military, economic and social security, and that it is their intention to work together both in war and peace to this end.' (Resolution ends).
 ...
 _considerations in mind. In the first place we have to take account of the fact that none of the Allied Governments except Greece is at war with Italy, and that Greece is not at war with Germany.
