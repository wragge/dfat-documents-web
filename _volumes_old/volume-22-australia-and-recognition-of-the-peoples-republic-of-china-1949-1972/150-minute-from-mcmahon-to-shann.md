...
naa_refs:
- naa_barcode: 1653802
  naa_control_symbol: 625/10/2 PART 2
  naa_series: A1838
  reference: '[NAA: A1838, 625/10/2, ii]'
title: MINUTE FROM McMAHON TO SHANN
...
You will see the notes I have made to the first draft. [1](#f1)

Please discuss with me when you have read them.

The changes to paragraphs 64[2](#f2) and 69[3](#f3) (pages 31 and 32) are of crucial _political_ importance.
...
Remember please that we have a D.L.P.—and that its reaction must be considered![4](#f4)
...
P.S. Attached are cuttings which reflect the D.L.P. views.[5](#f5)

P.P.S. I have just received the United States paper.[6](#f6) Does it lead to any changes in our own?
