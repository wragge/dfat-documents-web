...
naa_refs:
- naa_barcode: 280132
  naa_control_symbol: 112/2/1/2
  naa_series: A8411
  reference: '[NAA: A8411, 112/2/1/2]'
...
2\. It has been decided that Australia should support Japan's admission as member of Colombo Plan and we ourselves would consider sponsoring Japan.[3](#f3) It must be clear that Japanese participation in Plan would be as a donor and _not_ as a recipient country.[4](#f4)
...
4\. With reference to State Department's suggestion that Afghanistan be invited to attend Ottawa Conference as an observer, we are _not_ enthusiastic as Afghanistan can barely be said to fall within Colombo Plan area and we would be reluctant to divert part of our contribution to that area.[5](#f5) Before expressing a view we would want to know attitude of Pakistan.[6](#f6)
