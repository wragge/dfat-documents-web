...
doc_order: 343
naa_refs:
- naa_barcode: 12098847
  naa_control_symbol: KL1965/10
  naa_series: A6364
  reference: '[NAA: A6364, KL1965/10]'
...
Following is text of letter addressed to me[1](#f1) from the Tunku and handed to us by Ministry official this afternoon. Comments in our immediately following cable.[2](#f2)
...
2\. To us two important matters are involved in any resumption of trade between Singapore and Indonesia whatever the form and guise it may assume, and therefore I would much prefer Singapore to defer decision for some time until every aspect of these matters has been carefully considered:—[3](#f3)
...
(ii) Impose a blockade against vessels calling at Singapore anywhere within Singapore territorial waters from Indonesia for barter trading.[5](#f5)
