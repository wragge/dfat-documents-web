...
naa_refs:
- naa_barcode: 3251051
  naa_control_symbol: '6'
  naa_series: A10576
  reference: '[NAA: A10576, vi]'
title: BRIEF FOR AUSTRALIAN DELEGATION TO ANZUS COUNCIL MEETING 1953
...
3\. From a purely legal viewpoint there seems little reason why we should not recognise the Peking Government as soon as possible. To the lawyer’s mind, recognition of a Government, and, for that matter, its right to represent the country in the United Nations if that country is a member, does not imply either approval or disapproval of the regime concerned. Admittedly, Article IV of the Charter[2](#f2) does use the word ‘peace-loving’ and lays down certain obligations, but the lawyer would argue that this article relates solely to the question of the admission of a country to the organisation and is not relevant to the present case
