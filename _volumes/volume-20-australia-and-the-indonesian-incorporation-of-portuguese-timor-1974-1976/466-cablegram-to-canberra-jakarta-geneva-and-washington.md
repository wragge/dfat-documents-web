...
- naa_barcode: 4151387
  ...
  naa_series: A10005
  reference: '[NAA: A10005, TS202/1/l, ANNEX 3]'
title: Cablegram to Canberra, Jakarta, Geneva and Washington
...
Unless we can inject some new element I would not expect Winspeare to respond positively to our representations that he make a further visit to Timor in the near future or to associate himself with future Indonesian fact finding missions scheduled for 24 June.
  ...
  8. If these problems are not insuperable, an approach to Waldheim would I think be useful, even if in the event he declined to give a direction to Winspeare. A message by the Minister, together with any supplementary points you would wish me to make orally, would be an appropriate method.[6](#f6)
