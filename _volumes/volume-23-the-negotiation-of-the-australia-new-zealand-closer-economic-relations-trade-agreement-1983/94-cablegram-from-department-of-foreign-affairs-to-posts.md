...
Separate (in most cases BB(1)) messages contain the texts of:
  ...
  4. In the event that any host Government should raise the question of most favoured nation treatment on the basis of principles (c) and (d) of the communique such an approach should be referred to Canberra for a detailed reply.
