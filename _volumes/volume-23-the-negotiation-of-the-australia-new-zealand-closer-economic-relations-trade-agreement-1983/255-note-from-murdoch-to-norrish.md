...
doc_order: 255
naa_refs: []
title: Note from Murdoch to Norrish
...
Attached is a draft overview paper[1](#f1) for the Permanent Heads meeting.[2](#f2) It is a convenient enough summary of where the Joint Working Party stopped last week. It does not expose all of the options available to the Permanent Heads meeting to negotiate a new compromise document satisfactory to both sides, and nor does it delineate the shape of any possible packages, although in some areas the possible trade-offs are clear enough.
  ...
  6. The nagging question is 'what then, if this meeting of senior officials doesn't provide a package which both governments can accept?' Another Ministerial meeting? That is highly likely in that Mr Anthony already wants to deal directly with Mr Muldoon on the issue of the revise[d][4](#f4) phasing required for export incentives. In Brisbane[5](#f5) Mr Fraser turned aside Mr Muldoon's enquiry about holding to CER startup next year with the observation that implementing (as distinct, implicitly from negotiating) CER had not been considered by the Australian Cabinet.
