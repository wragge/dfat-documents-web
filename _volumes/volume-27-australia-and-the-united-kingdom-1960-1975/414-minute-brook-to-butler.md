...
- naa_barcode: 0
  naa_control_symbol: ''
  naa_series: ''
  reference: '[UKNA: PREM 11/3652]'
title: MINUTE BROOK TO BUTLER
...
In this paper the Commonwealth Secretary proposes that, in our relations with other Commonwealth countries, we should in future describe this country as ‘Britain’ instead of ‘United Kingdom’.[3](#f3)
...
> 
> (v) ‘Britain’ is an inaccurate description of ‘the United Kingdom’ since it does not include Northern lreland.[5](#f5)
...
I would have preferred that this paper should not be taken while the Prime Minister is away. But, if the Cabinet wish to discuss it tomorrow, I suggest that you should offer to report their views to the Prime Minister on his return.[6](#f6)
