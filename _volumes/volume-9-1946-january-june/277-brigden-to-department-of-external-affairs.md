...
7\. The relations between I.E.F.C. and the London Food Council [2] have yet to be thought out. The U.K. view is that the L.F.C. will no longer be a high level body, but that it will be necessary on 'the operational level' for implementing policies in detail.
